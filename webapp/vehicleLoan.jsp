            ...
            <form action="VehicleLoan" method="post">
                <table>
                    ...
                    <tr>
                        ...
                        <td><input class="inp" type="text" id="vehicleType" name="VehicleType" required></td>
                    </tr>
                    <tr>
                        <td><label for="vehicleModel">Vehicle Model:</label></td>
                        <td><input class="inp" type="text" id="vehicleModel" name="VehicleModel" required></td>
                    </tr>
                </table>
