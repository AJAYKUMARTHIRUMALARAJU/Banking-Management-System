...
<div id="container">
        <div id="formcontainer">
            ...
            <form action="HomeLoan" method="post">
                <table>
                    <tr>
                    ...
                    <tr>
                        <td><label for="propertyDetails">Property Details:</label></td>
                        <td><input class="inp" type="text" id="propertyDetails" name="propertyDetails" required></td>
                    </tr>
                    <tr>
